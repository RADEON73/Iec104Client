...
void iec104_class::parseAPDU(iec_apdu* papdu, int sz, bool accountandrespond)
{
    ...
    if (sz == 6) {
        ...
        if (valid_length)
            ...
            break;
            case M_ME_ND_1:
            { // 21: ANALOGIC NORMALIZED WITHOUT QUALITY
                char logpointbuf[15000] = "";
                unsigned int addr24 = 0;
                iec_type21* pobj;
                iec_obj* piecarr = new iec_obj[papdu->asduh.num];
            ...
            break;      case M_ME_NB_1:
            { // 11: ANALOGIC CONVERTED
                char logpointbuf[15000] = "";
                unsigned int addr24 = 0;
                iec_type11* pobj;
                iec_obj* piecarr = new iec_obj[papdu->asduh.num];
            ...
            break;
            case M_SP_TB_1:
            { // 30:  DIGITAL SINGLE WITH LONG TIME TAG
                char logpointbuf[15000] = "";
                unsigned int addr24 = 0;
                iec_type30* pobj;
                iec_obj* piecarr = new iec_obj[papdu->asduh.num];
            ...
            break;
            case M_DP_TB_1:
            { // 31: DIGITAL DOUBLE WITH LONG TIME TAG
                char logpointbuf[15000] = "";
                unsigned int addr24 = 0;
                iec_type31* pobj;
                iec_obj* piecarr = new iec_obj[papdu->asduh.num];
            ...
            break;
            case M_ME_TD_1:
            { //34 MEASURED VALUE, NORMALIZED WITH TIME TAG
                char logpointbuf[15000] = "";
                unsigned int addr24 = 0;
                iec_type34* pobj;
                iec_obj* piecarr = new iec_obj[papdu->asduh.num];
            ...
            break;
            case M_ME_TE_1:
            { //35 MEASURED VALUE, SCALED WITH TIME TAG
                char logpointbuf[15000] = "";
                unsigned int addr24 = 0;
                iec_type35* pobj;
                iec_obj* piecarr = new iec_obj[papdu->asduh.num];
            ...
            break;
            case M_ME_TF_1:
            { // 36 MEASURED VALUE, FLOATING POINT WITH TIME TAG
                char logpointbuf[15000] = "";
                unsigned int addr24 = 0;
                iec_type36* pobj;
                iec_obj* piecarr = new iec_obj[papdu->asduh.num];
            ...
            break;
            case M_EP_TF_1:
            { // 40 = Packed output circuit information of protection equipment with CP56Time2a time tag
                char logpointbuf[15000] = "";
                unsigned int addr24 = 0;
                iec_type40* pobj;
                iec_obj* piecarr = new iec_obj[papdu->asduh.num];
            ...
            break;
            case P_ME_NB_1:
            { // Parameter of scaled value, normalized value
                iec_type111* pobj;
            ...
            break;
            case P_ME_NC_1:
            { // Parameter of measured value, float value
                iec_type112* pobj;
